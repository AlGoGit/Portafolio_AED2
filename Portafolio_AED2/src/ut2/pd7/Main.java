...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] abonados = ManejadorArchivosGenerico.leerArchivo("src/ut2/pd7/abonados.txt");
        ...
        ManejadorArchivosGenerico.escribirArchivo("./src/ut2/pd7/salida.txt", buscados);
